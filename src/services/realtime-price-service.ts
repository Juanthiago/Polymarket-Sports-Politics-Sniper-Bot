...
export class RealtimePriceService {
  ...
  subscribe(conditionId: string, upTokenId: string, downTokenId: string): void {
    ...
    console.log(`Price WS subscribe ${shortId(conditionId)}`);
    this.connect();
  }
  ...
  unsubscribe(conditionId: string): void {
    ...
    console.log(`Price WS unsubscribe ${shortId(conditionId)}`);
  }
  ...
  private scheduleReconnect(): void {
    ...
    console.log(`Price WS reconnect #${this.reconnectAttempts} in ${delay}ms`);
